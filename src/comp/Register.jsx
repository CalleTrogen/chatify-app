...
function Register() {
    ...
    return (
        <>
            ...
            <p>Below you can register a new username. <br />Please fill in all columns.</p><br />
            ...
            <button onClick={handleRegister} className="bg-blue-700 text-white font-bold py-2 px-4 mt-10 m-3">Register</button>
        </>
    )
}
